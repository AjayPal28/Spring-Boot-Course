...
import com.ajay.exceptions.ResourceNotFoundException;
import com.ajay.repositories.EmployeeRepository;
import com.ajay.services.EmployeeService;
import com.ajay.services.SalaryAccountService;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Override
    @CachePut(cacheNames = CACHE_NAME, key = "#result?.id") // Ensure EmployeeDto has an id field
    @Transactional
