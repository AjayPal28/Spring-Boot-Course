...
public class PermissionMapping {
	...
	public static Map<Role, Set<Permissions>> map = Map.of(Role.USER, Set.of(Permissions.VIEW, Permissions.CREATE),
			Role.CREATER, Set.of(Permissions.VIEW, Permissions.CREATE, Permissions.UPDATE), Role.ADMIN,
			Set.of(Permissions.VIEW, Permissions.UPDATE, Permissions.DELETE));
